...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: Shape, Border, Ellipse, Actor, Connector, ShapeFactory, Rect, Svg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _shapefactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shapefactory */ "./src/shapefactory.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ShapeFactory", function() { return _shapefactory__WEBPACK_IMPORTED_MODULE_5__["ShapeFactory"]; });
...
var ShapeFactory = /** @class */ (function () {
    ...
    ShapeFactory.prototype.mouseDown = function (event) {
    ...
    ShapeFactory.prototype.mouseUp = function (event) {
        console.log("Bye");
        this.info.right = event.clientX;
        this.info.bottom = event.clientY;
        this.postNewPointFunc(this.info);
    };
    ShapeFactory.prototype.setExportFunction = function (callback) {
