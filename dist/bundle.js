(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ChartDraw"] = factory();
	else
		root["ChartDraw"] = factory();
})(window, function() {
...
/*!**********************!*\
  !*** ./src/index.ts ***!
  \**********************/
/*! exports provided: ShapeType, Shape, Border, Ellipse, Actor, Connector, MouseReader, Rect, Svg, ShapeFactory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shape_shape_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shape/shape.type */ "./src/shape/shape.type.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ShapeType", function() { return _shape_shape_type__WEBPACK_IMPORTED_MODULE_0__["ShapeType"]; });

/* harmony import */ var _shape_shape__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./shape/shape */ "./src/shape/shape.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Shape", function() { return _shape_shape__WEBPACK_IMPORTED_MODULE_1__["Shape"]; });

/* harmony import */ var _shape_border__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shape/border */ "./src/shape/border.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Border", function() { return _shape_border__WEBPACK_IMPORTED_MODULE_2__["Border"]; });

/* harmony import */ var _shape_ellipse__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shape/ellipse */ "./src/shape/ellipse.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Ellipse", function() { return _shape_ellipse__WEBPACK_IMPORTED_MODULE_3__["Ellipse"]; });

/* harmony import */ var _shape_actor__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./shape/actor */ "./src/shape/actor.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Actor", function() { return _shape_actor__WEBPACK_IMPORTED_MODULE_4__["Actor"]; });

/* harmony import */ var _shape_connector__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./shape/connector */ "./src/shape/connector.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Connector", function() { return _shape_connector__WEBPACK_IMPORTED_MODULE_5__["Connector"]; });

/* harmony import */ var _mouse_reader__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mouse.reader */ "./src/mouse.reader.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MouseReader", function() { return _mouse_reader__WEBPACK_IMPORTED_MODULE_6__["MouseReader"]; });

/* harmony import */ var _models_rect__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/rect */ "./src/models/rect.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Rect", function() { return _models_rect__WEBPACK_IMPORTED_MODULE_7__["Rect"]; });

/* harmony import */ var _svg__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./svg */ "./src/svg.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Svg", function() { return _svg__WEBPACK_IMPORTED_MODULE_8__["Svg"]; });

/* harmony import */ var _shape_shape_factory__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shape/shape.factory */ "./src/shape/shape.factory.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ShapeFactory", function() { return _shape_shape_factory__WEBPACK_IMPORTED_MODULE_9__["ShapeFactory"]; });
...
/*!*****************************!*\
  !*** ./src/mouse.reader.ts ***!
  \*****************************/
/*! exports provided: MouseReader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MouseReader", function() { return MouseReader; });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _models_rect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/rect */ "./src/models/rect.ts");


var MouseReader = /** @class */ (function () {
    function MouseReader() {
        var _this = this;
        var down = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(document, 'mousedown');
        var up = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(document, 'mouseup');
        var move = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(document, 'mousemove');
        down.subscribe(function (d) { return _this.mouseDown(d); });
        up.subscribe(function (d) { return _this.mouseUp(d); });
        //let drag$ = down$.pipe(
    ...
    MouseReader.prototype.mouseDown = function (event) {
        console.log("Hello " + event.clientX + " " + event.clientY);
        this.info = new _models_rect__WEBPACK_IMPORTED_MODULE_1__["Rect"]();
        this.info.left = event.clientX;
        this.info.top = event.clientY;
    };
    MouseReader.prototype.mouseUp = function (event) {
        console.log("Bye");
        this.info.right = event.clientX;
        this.info.bottom = event.clientY;
        this.postNewPointFunc(this.info);
    };
    MouseReader.prototype.setExportFunction = function (callback) {
...
/* harmony import */ var _shape__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shape */ "./src/shape/shape.ts");
...
var Actor = /** @class */ (function (_super) {
    ...
    Actor.prototype.drawHead = function (shapeInfo) {
        var result = this.extractRectanglePos(shapeInfo);
        var ellipse = document.createElementNS(this.ns, 'circle');
        ellipse.setAttributeNS(null, 'cx', (result.left + ((result.right - result.left) / 2)).toString());
        var headRx = (result.bottom - result.top) / 8;
    ...
    Actor.prototype.drawBody = function (shapeInfo) {
        var result = this.extractRectanglePos(shapeInfo);
        //Body
        var ellipse = document.createElementNS(this.ns, 'line');
        var headRx = (result.bottom - result.top) / 4;
...
var Border = /** @class */ (function (_super) {
    ...
    Border.prototype.draw = function () {
        ...
        var result = this.extractRectanglePos(this._rectangularPosition);
...
var Connector = /** @class */ (function (_super) {
    ...
    function Connector(svg) {
        var _this = _super.call(this, svg) || this;
        _this._beginObject = null;
        _this._endObject = null;
        return _this;
    }
    Object.defineProperty(Connector.prototype, "beginObject", {
        get: function () {
    ...
    Object.defineProperty(Connector.prototype, "endObject", {
        get: function () {
...
var Ellipse = /** @class */ (function (_super) {
    ...
    Ellipse.prototype.draw = function () {
        var ellipse = document.createElementNS(this.ns, 'ellipse');
        var _a = this.extractRectanglePos(this._rectangularPosition), right = _a.right, left = _a.left, bottom = _a.bottom, top = _a.top;
        var rx = (right - left) / 2;
        var ry = (bottom - top) / 2;
...
/***/ "./src/shape/shape.factory.ts":
/*!************************************!*\
  !*** ./src/shape/shape.factory.ts ***!
  \************************************/
/*! exports provided: ShapeFactory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShapeFactory", function() { return ShapeFactory; });
/* harmony import */ var _shape_type__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shape.type */ "./src/shape/shape.type.ts");
/* harmony import */ var _actor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./actor */ "./src/shape/actor.ts");
/* harmony import */ var _ellipse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ellipse */ "./src/shape/ellipse.ts");



var ShapeFactory = /** @class */ (function () {
    function ShapeFactory(svg) {
        this.svg = svg;
    }
    ShapeFactory.prototype.createShape = function (shape) {
        switch (shape) {
            case _shape_type__WEBPACK_IMPORTED_MODULE_0__["ShapeType"].Actor:
                var actor = new _actor__WEBPACK_IMPORTED_MODULE_1__["Actor"](this.svg);
                return actor;
            case _shape_type__WEBPACK_IMPORTED_MODULE_0__["ShapeType"].Ellipse:
                var ell = new _ellipse__WEBPACK_IMPORTED_MODULE_2__["Ellipse"](this.svg);
                return ell;
        }
    };
    return ShapeFactory;
...
/* harmony import */ var _models_rect__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/rect */ "./src/models/rect.ts");
...
var Shape = /** @class */ (function () {
    ...
    Object.defineProperty(Shape.prototype, "rectangularPosition", {
        get: function () {
    ...
    Shape.prototype.extractRectanglePos = function (info) {
        var result = new _models_rect__WEBPACK_IMPORTED_MODULE_0__["Rect"]();
...
var ShapeType;
(function (ShapeType) {
    ShapeType[ShapeType["Actor"] = 0] = "Actor";
    ShapeType[ShapeType["Ellipse"] = 1] = "Ellipse";
    ShapeType[ShapeType["Border"] = 2] = "Border";
    ShapeType[ShapeType["Connector"] = 3] = "Connector";
})(ShapeType || (ShapeType = {}));
...
var Svg = /** @class */ (function () {
    function Svg(svgId) {
        ...
        var div = document.getElementById(svgId);
        this.svg = document.createElementNS(this.ns, 'svg');
        this.svg.setAttributeNS(null, 'width', '100%');
        this.svg.setAttributeNS(null, 'height', '100%');
        div.appendChild(this.svg);
